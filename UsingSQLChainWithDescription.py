...
from SQLChainWithDescription import SQLChainWithDescription
...
Question: {input}
SQLQuery:"""
DESCRIPTION_TEMPLATE = """ Given the tables, describe each of the tables in one sentence, explaining the information it contains.
Tables:
{table_info}
...
class SQLWithDescription:
    def __init__(self, db_id, key):
        ...
        self.db_chain = SQLChainWithDescription.from_llm(self.llm, self.db,description_prompt = description_prompt, SQL_prompt=few_shot_prompt_template, verbose=True)
